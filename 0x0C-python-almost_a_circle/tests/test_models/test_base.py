...
""" A module defining Unit test for models/base.py file"""
...
class Test_Base(unittest.TestCase):
    ...
    def test_instance_type_id_class(self):
        ...
        self.assertFalse(id(b1) is id(Base))
        b2 = Base()
        self.assertTrue(type(b1) is type(b2))
        self.assertFalse(id(b1) is id(b2))
    ...
    def test_id_value(self):
        ...
        b1 = Base(100e1000)
        self.assertEqual(b1.id, 100e1000)
        b1.__init__(30)
    ...
    def test_from_json_string(self):
        ...
        self.assertEqual(
            list_output,
            [
                {"height": 4, "width": 10, "id": 89, "x": 3, "y": 2},
                {"height": 7, "width": 1, "id": 7, "x": 3},
            ],
        )
        self.assertTrue(type(list_output) is list)
